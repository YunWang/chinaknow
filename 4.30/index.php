...
if ($rowsActivity == null) {
    # code...
    echo "<script>alert('Sorry!There is still no any activity!');</script>";
}
if ($rowsPost == null) {
    # code...
    echo "<script>alert('Sorry!There is still no any post!');</script>";
}if ($rowsArticle == null) {
    # code...
    echo "<script>alert('Sorry!There is still no any article!');</script>";
}
?>
<!DOCTYPE html>
<html>
...
<body>
     ...
     <div class="bg">
         <img id="bg-img" src="images/background%20.jpg">
         ...
         <div class="wrap">
             ...
             <div class="inf1">
                 <div class="content">
                     <ul>
                         <div class="title">
                             <li><a href="information.html">New Information</a> </li>
                         </div>
                         <div class="tb">
         ...
         <div class="wrap">
             ...
             <div id="inf2">
                 <div class="content">
                     <ul>
                         <div class="title">
                             <li><a href="information.html">Sharing</a> </li>
                         </div>
                         <div class="tb">
