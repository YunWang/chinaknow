...
<div class="post">
    <div class="post1" >Create Your Post</div>
   <form action="doPost.php" method="post">
       <div class="post2">
           Title:
       </div>
       <div class="post3">
           <input type="text" placeholder="Enter your title" style="width: 200px; height: 28px;" name="articleTitle"/>
       </div>
    ...
    <textarea id="editor_id" name="articleDetail" style="width:700px;height:300px;"></textarea>
       ...
       <div class="btns">
           ...
           <button type="submit" onclick="post-create.html">Cancel</button>
       </div>
       </div>
   </form>
</div>
