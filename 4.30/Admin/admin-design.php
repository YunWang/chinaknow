...
if(!$rows){
    alertMes("sorry,没有管理员,请添加!","addAdminView.html");
    exit;
}
?>
<!doctype html>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="addAdminView.html"><i class="icon-font"></i>Add New</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="link-update" onclick="editAdmin(<?php echo $row['id'];?>)">修改</a>
                                <a class="link-del" onclick="delAdmin(<?php echo $row['id'];?>)">删除</a>
                            </td>
                        </tr>
                        <?php $i++;endforeach;?>
...
<script type="text/javascript">
    function editAdmin(id){
        window.location = "editAdminView.php?id="+id;
    }
