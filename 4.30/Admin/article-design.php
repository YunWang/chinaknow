...
if(!$rows){
    alertMes("sorry,没有文章,请添加!","article-addView.php");
    exit;
}
?>
<!doctype html>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="article-addView.php"><i class="icon-font"></i>Add New</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td title=""><a target="_blank" href="#" title=""><?php echo $row['articleTitle'];?></a>
                            </td>
                            ...
                            <td>
                                <a class="link-update" onclick="editArticle(<?php echo $row['id'];?>)">修改</a>
                                <a class="link-del" onclick="delArticle(<?php echo $row['id'];?>)">删除</a>
                            </td>
                        </tr>
                        <?php $i++;endforeach;?>
...
<script type="text/javascript">
    function editArticle(id){
        window.location = "article-editView.php?id="+id;
    }
    function delArticle(id){
        if(window.confirm("您确定要删除吗？删除之后不可以恢复哦！！！")){
                window.location="article-delete.php?id="+id;
            }
    }
</script>
</html>
