    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="activity-edit.php?id=<?php echo $rowActivity['id'];?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>ActivityTitle:</th>
                                <td>
                                    <input class="common-text required" id="ActivityTitle" name="ActivityTitle" size="50" value="" type="text" placeholder="<?php echo $rowActivity['activityTitle'];?>">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="frm-field required" id="tagName" name="tagName" onchange="">
                                        <option value="<?php echo $rowActivity['tagName'];?>"><?php echo $rowActivity['tagName'];?></option>
                            ...
                            <tr>
                                ...
                                <td><textarea name="activityDetail" class="common-textarea" id="activityDetail" cols="30" style="width: 98%;" rows="10" placeholder="<?php echo $rowActivity['activityDetail'];?>"></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
