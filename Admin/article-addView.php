    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="article-add.php" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>ArticleTitle:</th>
                                <td>
                                    <input class="common-text required" id="articleTitle" name="articleTitle" size="50" value="" type="text" >
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><textarea name="articleDetail" class="common-textarea" id="articleDetail" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
