...
$rows=getTagByPage($pageSize);
if(!$rows){
    alertMes("sorry,没有标签,请添加!","tag-addView.html");
    exit;
}
?>
<!doctype html>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="tag-addView.html"><i class="icon-font"></i>Add New</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['parentTag'];?></td>
                            <td>
                                <a class="link-update" onclick="editTag(<?php echo $row['id'];?>)">修改</a>
                                <a class="link-del" onclick="delTag(<?php echo $row['id'];?>)">删除</a>
                            </td>
                        </tr>
                        <?php $i++;endforeach;?>
                    </table>
...
<script type="text/javascript">
    function editTag(id){
        window.location = "tag-editView.php?id="+id;
    }
    function delTag(id){
        if(window.confirm("您确定要删除吗？删除之后不可以恢复哦！！！")){
                window.location="tag-delete.php?id="+id;
            }
    }
</script>
</html>
