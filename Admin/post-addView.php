...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.php">Index</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="post-design.php">Management</a><span class="crumb-step">&gt;</span><span>Add New</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="post-add.php" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>postTitle:</th>
                                <td>
                                    <input class="common-text required" id="postTitle" name="postTitle" size="50" value="" type="text" >
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><textarea name="postDetail" class="common-textarea" id="postDetail" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
