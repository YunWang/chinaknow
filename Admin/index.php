        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">System</label><span class="res-info">WINNT</span>
                    </li>
                    <li>
                        <label class="res-lab">Environment</label><span class="res-info">Apache/2.2.21 (Win64) PHP/5.3.10</span>
                    </li>
                    <li>
                        <label class="res-lab">PHP</label><span class="res-info">apache2handler</span>
                    </li>
                    <li>
                        <label class="res-lab">Attachment Limit</label><span class="res-info">2M</span>
                    </li>
                    <li>
                        <label class="res-lab">Time</label><span class="res-info">2016.4.17 21:08:24</span>
                    </li>
                    <li>
                        <label class="res-lab">IP</label><span class="res-info">localhost [ 127.0.0.1 ]</span>
                    </li>
                    <li>
