...
//comment
$sql="select *from ".POSTCOMMENT." where postId='{$id}'";
        ...
        <div class="wrapper">
          <div id="content">
            ...
            <div id="comments">
              ...
              <div id="respond">
                <h3>Leave a Reply</h3>
                <form method="post" action="doPostComment.php?id=<?php echo $row['id'];?>">
                  <div class="divider">
                  <p class="full">
          ...
          <div id="sidebar">
            <div class="box">
              ...
              <div class="nav">
                <ul>
                  <?php if ($rows != null) :?>
                  <?php foreach ($rows as $rowPost) :?>
                  <li><a href="post.php?id=<?php echo $rowPost['id'];?>"><?php echo $rowPost['postTitle'];?></a></li>
                  <!-- <li><a onclick="articleDetail(<?php echo $rowPost['id'];?>)"><?php echo $rowPost['postTitle'];?></a></li> -->
                  <?php endforeach;?>
                  <?php endif;?>
